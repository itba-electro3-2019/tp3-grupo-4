...
Para finalizar era necesario un circuito que indicará cuando el siguiente estado iba a provenir del cirucito de entrada lógico del Caso I o del Caso II. Por ende, se implementa un multiplexor cuya entrada de activacion va a estar dada por el Caso II. \par
